...
void setup() {
  ...
  // Initialize relays to LOW (triggered by default)
...
void loop() {
  // Read sensor values
  float sensorValue1 = digitalRead(sensor1);
  float sensorValue2 = digitalRead(sensor2);
  float sensorValue3 = digitalRead(sensor3);
